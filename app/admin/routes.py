...
def add_page():
    ...
    if form.validate_on_submit():
        ...
        page = Page(
                ...
                banner_video = form.banner_video.data,
                body = form.body.data,
...
def edit_page(id, ver_id=None):
    ...
    if form.validate_on_submit():
        ...
        page.banner_video = form.banner_video.data
    ...
    if version:
        ...
        form.banner_video.data = version.banner_video
        ...
        form.banner_video.data = page.banner_video
